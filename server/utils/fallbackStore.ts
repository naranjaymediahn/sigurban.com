...
function buildDefaultHeroSlides(createdAt: string) {
  return [
    {
      media_type: 'image',
      image: '/images/slider_main/crema-sula-chongo-rojo-y-amarrar.png',
      video: null,
      title_es: 'CREMA AUTÉNTICA HECHA EN CENTROAMÉRICA',
      title_en: 'AUTHENTIC CREAM MADE IN CENTRAL AMERICA',
      alt_es: 'Crema Sula auténtica hecha en Centroamérica',
      alt_en: 'Authentic Sula cream made in Central America',
      image_class: 'image crema',
      title_class: 'heading crema',
      sort_order: 0,
    },
    {
      media_type: 'image',
      image: '/images/slider_main/Sula-jugos-940-y-470.png',
      video: null,
      title_es: 'FIESTAS DE SABORES Y DELICIOSAS FRUTAS',
      title_en: 'A FIESTA OF FLAVORS AND DELICIOUS FRUITS',
      alt_es: 'Jugos Sula manzana, naranja y ponche de frutas',
      alt_en: 'Sula apple, orange and fruit punch juices',
      image_class: 'image',
      title_class: 'heading jugo',
      sort_order: 1,
    },
    {
      media_type: 'image',
      image: '/images/slider_main/Sula-nectar-200-ml.png',
      video: null,
      title_es: 'TRES SABORES QUE SON UNA DELICIA NATURAL EN TU MESA',
      title_en: 'THREE FLAVORS THAT ARE A NATURAL DELIGHT AT YOUR TABLE',
      alt_es: 'Néctares Sula de sabores naturales',
      alt_en: 'Sula nectars with natural flavors',
      image_class: 'image nectar',
      title_class: 'heading nectar',
      sort_order: 2,
    },
    {
      media_type: 'image',
      image: '/images/slider_main/Sula-malteadas-470-y-200-ml.png',
      video: null,
      title_es: 'MALTEADAS EN TRES DELICIOSOS SABORES',
      title_en: 'MILKSHAKES IN THREE DELICIOUS FLAVORS',
      alt_es: 'Malteadas Sula vainilla, chocolate y fresa',
      alt_en: 'Sula vanilla, chocolate and strawberry milkshakes',
      image_class: 'image',
      title_class: 'heading jugo',
      sort_order: 3,
    },
